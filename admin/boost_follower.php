    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card p-5">
                        <div class="text-center mb-4"><h1 class="h3 text-success fw-bold"><i class="bi bi-person-plus-fill me-2"></i>Boost Page Followers</h1><p class="text-muted">Add a Facebook page to increase your follower count.</p></div>
                        <form method="POST">
                            ...
                            <div class="mb-4"><label class="form-label fw-bold">Target Followers (Optional)</label><div class="input-group"><span class="input-group-text"><i class="bi bi-bullseye"></i></span><input type="number" class="form-control form-control-lg" name="target_followers" placeholder="e.g. 5000" value="0"></div></div>
                            ...
                            <div class="d-grid"><button type="submit" name="boost_follower" class="btn btn-success btn-lg fw-bold shadow-sm"><i class="bi bi-graph-up-arrow me-2"></i>Start Boosting Followers</button></div>
                        </form>
                    </div>
                </div>
            </div>
