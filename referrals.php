...
<head>
    ...
    <style>
        ...
        .hero-section { background: linear-gradient(135deg, #36b9cc 0%, #258391 100%); color: white; padding: 5rem 0; margin-bottom: 3rem; clip-path: polygon(0 0, 100% 0, 100% 85%, 0 100%); }
    ...
    <div class="container py-4">
        <div class="row g-4">
                        ...
                        <div class="public-sidebar w-100">
                            ...
                            <div class="sidebar-menu py-3">
                                <nav class="nav flex-column">
                                    ...
                                    <a class="nav-link active" href="referrals.php"><i class="bi bi-people-fill"></i> Referrals</a>
            ...
            <div class="col-lg-9">
                ...
                <div class="hero-section text-center shadow-lg">
                    <div class="container">
                        <h1 class="fw-bold display-5 mb-3">Referral History</h1>
                        <p class="lead opacity-75">Track your invites and earnings.</p>
                    </div>
                </div>

        <div class="row g-4 mb-5 justify-content-center">
            <div class="col-md-4">
                <div class="card stat-card text-white p-3 text-center" style="background: linear-gradient(135deg, #4e73df 0%, #224abe 100%);">
            ...
            <div class="col-md-4">
                <div class="card stat-card text-white p-3 text-center" style="background: linear-gradient(135deg, #1cc88a 0%, #13855c 100%);">
                    <div class="card-body p-4">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header text-white p-4" style="background: linear-gradient(135deg, #36b9cc 0%, #258391 100%); border:none;">
                <h5 class="mb-0 fw-bold"><i class="bi bi-people-fill me-2"></i>Referred Users</h5>
            </div>
                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            <?php if($total_referrals > 0): ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="3" class="text-center py-5 text-muted">You haven't referred anyone yet. Share your code: <strong><?php echo htmlspecialchars($user_referral_code); ?></strong></td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
